...
const avataresPremium = <AvatarPremium>[
  AvatarPremium('🐭', 'Ratón', 15),
  AvatarPremium('🐮', 'Vaca', 15),
  AvatarPremium('🐥', 'Pollito', 20),
  AvatarPremium('🦋', 'Mariposa', 20),
  AvatarPremium('🐠', 'Pez', 20),
  AvatarPremium('🐝', 'Abeja', 25),
  AvatarPremium('🐦', 'Pájaro', 25),
  AvatarPremium('🐨', 'Koala', 40),
  AvatarPremium('🦒', 'Jirafa', 40),
  AvatarPremium('🐢', 'Tortuga', 45),
  AvatarPremium('🦓', 'Cebra', 50),
  AvatarPremium('🐙', 'Pulpo', 60),
  AvatarPremium('🦩', 'Flamenco', 65),
  AvatarPremium('🦘', 'Canguro', 70),
  AvatarPremium('🦔', 'Erizo', 75),
  AvatarPremium('🐳', 'Ballena', 80),
  AvatarPremium('🐲', 'Dragón', 100),
  AvatarPremium('🦖', 'T-Rex', 120),
  AvatarPremium('🦄', 'Unicornio', 150),
];
